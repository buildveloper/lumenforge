...
- Reports problems as terse symptom statements (e.g. "i cannot signin or signup") and expects the agent to diagnose the root cause itself — reproducing the failure first rather than asking for steps or guessing. Confidence: 0.65
