  ...
  return (
    <Tabs defaultValue="profile">
      ...
      <TabsContent value="profile" className="flex flex-col gap-8">
        <SectionCard
          title="Account"
          description="Your name, email, password, and sessions are managed by our authentication provider."
        >
          <Row
            title={data.profile.name ?? "Unnamed account"}
            description={data.profile.email ?? "No email on file"}
          >
      ...
      <TabsContent value="security">
        <SectionCard
          title="Security"
          description="Passwords, multi-factor authentication, connected devices, and active sessions all live in your account settings."
        >
          <Row
            title="Sign-in and sessions"
            description="Change your password, enable MFA, or sign out other devices."
          >
            <Button variant="outline" size="sm" onClick={() => clerk.openUserProfile()}>
