...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t border-border bg-surface-sunken/50 font-medium", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    scope="col"
    className={cn("col-head h-9 whitespace-nowrap px-3 text-left align-middle", className)}
    {...props}
  />
));
